...
library(knitr)
library(caret)
library(choroplethr) #install_github("choroplethr", "trulia")
library(choroplethrZip) #install_github('arilamstein/choroplethrZip@v1.5.0')
...
```{r, echo = FALSE}
#let's show the HCAHPS Star rating by zip code in NY
df_star_zip <- hcahps %>%
...
zip_choropleth(df_star_zip, 
               ...
               title="HCAHPS Star Rating by Zip Code",
               legend="Star Rating")
...
=======
Let's see if there is a relationship between the number of patients dischaged and mean cost in this dataset. The idea behind this hypothesis is that hospitals that treat more patients for a certain procedure or disorder may have improved efficiencies that allows hospitals to lower the treatmet charge. 
>>>>>>> 606f4e677d33220e77d6861460511a5d62794ca1
