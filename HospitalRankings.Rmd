...
HCAHPS_sum <- hcahps %>%
  ...
  right_join(HCAHPS_sum, by = "Provider.ID")

HCAHPS_sum[HCAHPS_sum == "Not Available"] = NA
HCAHPS_sum <- na.omit(HCAHPS_sum)

HCAHPS_sum$HCAHPS.Linear.Mean.Value <- as.numeric(as.character(HCAHPS_sum$HCAHPS.Linear.Mean.Value))

#refactor star rating to account for removed factors
HCAHPS_sum$H_STAR_RATING <- factor(HCAHPS_sum$H_STAR_RATING)
