...
facility_orig = c("ADIRONDACK MEDICAL CENTER-SARANAC LAKE SITE", "BRONX-LEBANON HOSPITAL CENTER - CONCOURSE DIVISION", "BRONX-LEBANON HOSPITAL CENTER - FULTON DIVISION", "BROOKHAVEN MEMORIAL HOSPITAL MEDICAL CENTER INC", "BROOKLYN HOSPITAL CENTER AT DOWNTOWN CAMPUS", "CATSKILL REGIONAL MEDICAL CENTER - G. HERMANN SITE", "CHAMPLAIN VALLEY PHYSICIANS HOSPITAL MEDICAL CENTER", "CLIFTON-FINE HOSPITAL", "EASTERN NIAGARA HOSPITAL - LOCKPORT DIVISION")
facility_new = c("ADIRONDACK MEDICAL CENTER", "BRONX-LEBANON HOSPITAL CENTER", "BRONX-LEBANON HOSPITAL CENTER", "BROOKHAVEN MEMORIAL HOSPITAL MEDICAL CENTER", "BROOKLYN HOSPITAL CENTER", "CATSKILL REGIONAL MEDICAL CENTER - G HERMANN SITE", "CHAMPLAIN VALLEY PHYSICIANS HOSPITAL MEDICAL CTR", "CLIFTON FINE HOSPITAL", "EASTERN NIAGARA HOSPITAL")

#clean names in FacilityID
facilityID_data$Facility.Name[facilityID_data$Facility.Name == "ADIRONDACK MEDICAL CENTER-SARANAC LAKE SITE"] <- "ADIRONDACK MEDICAL CENTER"
